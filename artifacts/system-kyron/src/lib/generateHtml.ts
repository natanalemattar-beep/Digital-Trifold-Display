...
const ICONS = {
  ...
  receipt:     `<polyline points="20 12 20 22 4 22 4 12"/><rect x="2" y="7" width="20" height="5"/><line x1="12" y1="22" x2="12" y2="7"/><line x1="7" y1="11" x2="7.01" y2="11"/>`,
  scale:       `<line x1="12" y1="3" x2="12" y2="21"/><path d="M3 8l4-4 4 4"/><path d="M17 8l4-4-4-4"/><line x1="3" y1="12" x2="21" y2="12"/>`,
...
function buildPanel2(): string {
  const stats = [
    ...
    { num: "134 h",   label: "Horas perdidas al año en papeleo (OCDE)", ic: "bar" as const,       c: "#38BDF8" },
